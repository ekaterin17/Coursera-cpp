...
//    array<Item, static_cast<uint32_t>(TAirport::Last_)> GetItems() const {
//        array<Item, static_cast<uint32_t>(TAirport::Last_)> return_value;
//        for (size_t i = 0; i < static_cast<size_t>(TAirport::Last_); ++i) {
//            return_value[i] = {static_cast<TAirport>(i), airports[i]};
//        }
//        return return_value;
//    }
//
