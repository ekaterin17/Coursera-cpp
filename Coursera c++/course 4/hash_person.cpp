...
//        int x = 53;
//        return shash(address.city) * x * x + shash(address.street) * x + ihash(address.building);
//    }
//};
//
//struct PersonHasher {
...
//    hash<string> shash;
//    hash<int> ihash;
//    AddressHasher addresHasher;
//
//    size_t operator() (const Person& person) const {
//        int x = 85;
//        return shash(person.name) * x * x + ihash(person.height) * x + dhash(person.weight) + 2 * addresHasher(person.address);
//    }
//};
//
//
