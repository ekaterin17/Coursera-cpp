...
//        V& ref_to_value;
//        
//        WriteAccess(const K& key, Data& bucket_content)
...
//        
//        ReadAccess(const K& key, const Data& bucket_content)
//        : guard(bucket_content.mtx)
...
//        auto& bucket = data[GetBucketIndex(key)];
...
//        const auto& bucket = data[GetBucketIndex(key)];
//        return bucket.bucket.find(key) != bucket.bucket.end();
//    }
//    
//    MapType BuildOrdinaryMap() const {
//        MapType result;
//        for (auto& bucket: data) {
//            lock_guard(bucket.mtx);
//            result.insert(bucket.bucket.begin(), bucket.bucket.end());
//        }
//        return result;
//    }
//private:
